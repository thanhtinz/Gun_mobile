...
public static void HomeTempleScreen(RectTransform safe, GameApp app)
        ...
        public static void SigilScreen(RectTransform safe, GameApp app)
        {
            ...
            SysUi.Note(body, "符印技能 TS_SigilSkillTemplate.xml  已学 " + (app.Profile.SigilSkillIds != null ? app.Profile.SigilSkillIds.Count : 0));
            SysUi.Row(body, "sigilskills", "打开符印技能", () => ExtraModulesScreens.SigilSkillScreen(safe, app));
        }
        ...
        public static void SigilSkillScreen(RectTransform safe, GameApp app)
        {
            ...
            foreach (SigilSkillTemplate row in app.Database.SigilSkillList)
            {
                ...
                SysUi.Row(body, "ssk" + row.SkillId,
                    ...
                    owned ? null : (System.Action)(() => PhoneNet.UnlockSigilSkill(local.SkillId)));
                if (++shown >= 36) break;
            }
